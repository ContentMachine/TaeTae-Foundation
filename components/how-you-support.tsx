  ...
  return (
    <section className="bg-secondary dark:bg-gray-800 py-16 md:py-24 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          {ways.map((way, idx) => {
            ...
            return (
              <div
                key={idx}
                className="bg-white dark:bg-gray-900 p-8 rounded-lg shadow-sm border border-border hover:border-primary transition-all text-center group"
              >
        ...
        <div className="bg-linear-to-br from-primary to-[#173510] dark:from-[#0a1421] dark:to-[#0a1421] text-white p-8 md:p-12 rounded-lg text-center">
          <h3 className="text-3xl md:text-4xl font-bold mb-3">Your Impact Matters</h3>
